...
THIS SECTION IS INTENTIONALLY LEFT UNTOUCHED. I have not decided if I will keep this template and solely work in `manuscript` or copy it over. For now I just want to keep the structure intact so that I can make that decision later without having to clone and redownload this .qmd from the original template.
